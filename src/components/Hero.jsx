    ...
    return (
        <div>
            <div className='pt-16 px-4 sm:pt-20 lg:pt-[95.1px]'>
                ...
                {/* Banner pill */}
                <div className="max-w-[434.1px] mx-auto h-7.5 w-full mt-8.25 uppercase bg-[linear-gradient(90deg,#4020C1_0%,#8432D6_100%)] text-yellow rounded-[22px] flex justify-center items-center text-xs sm:text-sm px-3 text-center">
                ...
                <div className='min-[1200.1px]:hidden flex flex-col w-full lg:w-auto items-center'>
                    <div className='p-px bg-[linear-gradient(90deg,#4020C1_0%,#8432D6_100%)] flex justify-center mt-4 w-fit rounded-2xl h-fit relative'>
                        <div className='w-[183.1px] h-[33.1px] rounded-3xl bg-dark-yellow absolute -mt-4 flex items-center justify-center'>
                            <a className='text-light-blue leading-110 text-sm font-bold'>1 $hPEPE = 0.009 USD</a>
                        </div>
                        <div className="bg-[url(/assets/png/Card.png)] text-center px-4 rounded-2xl sm:px-7 bg-cover bg-no-repeat bg-center w-full max-w-[509.1px] ">
                            <h3 className='uppercase font-black text-yellow text-xl leading-110 pt-8'>Early Frogs Catch The Gains</h3>
                            <p className='mt-2.5 text-dark-yellow text-base leading-180'>Get in on the ground floor for a 20x gain on launch.</p>
                            <p className='text-yellow max-w-[449.1px] text-sm leading-144 mt-5'>You'll be directed to a secure checkout page where you can finalize your purchase using a variety of major cryptocurrencies.</p>
                            ...
                            <div className='flex mt-6 flex-row w-full max-w-108 justify-between items-center flex-wrap gap-2'>
                                ...
                                <p className='text-yellow font-black text-sm leading-110 uppercase'>USD RAISED: <span className='text-greenry'>$5,318,343</span></p>
                            </div>
                            ...
                            <div className='flex flex-col sm:flex-row w-full mt-7.5 justify-between gap-2.5 relative'>
                                <div className='max-w-full sm:max-w-[228.1px] w-full'>
                                    <p className='leading-100 text-start ml-2 mb-1.25 text-xs font-medium text-yellow'>USD You Pay</p>
                                    <div className='items-center w-full p-3 h-[65.1px] rounded-[10px] bg-white flex flex-row justify-between'>
                                        <p className='text-[#ADADAD] text-base leading-100 tracking-[-2%] font-semibold'>100</p>
                                        <div className='w-15 flex flex-row gap-2 mr-3.5'>
                                            <Image src={'/assets/png/usflag.png'} width={24} height={24} alt='flag' />
                                            <p className='text-base text-dark'>USD</p>
                                        </div>
                                    </div>
                                </div>

                                {/* Equal icon — repositioned for flex-col on mobile */}
                                <div className='hidden sm:flex absolute translate-x-[480%] translate-y-[64%]'>
                                    <Icons icon={'equal'} />
                                </div>
                                ...
                                <div className='max-w-full sm:max-w-[228.1px] w-full'>
                                    <p className='leading-100 text-start ml-2 mb-1.25 text-xs font-medium text-yellow'>$hPepe You Get</p>
                                    <div className='items-center w-full p-3 h-[65.1px] rounded-[10px] bg-white flex flex-row justify-between'>
                                        <p className='text-[#ADADAD] text-base ml-2.5 leading-100 tracking-[-2%] font-semibold'>11,111.11</p>
                                        <div className='w-20.5 flex flex-row gap-2'>
                                            <Image src={'/assets/png/coin.png'} width={24} height={24} alt='flag' />
                                            <p className='text-base text-dark -ml-1'>$hPEPE</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <p className='text-xs mt-2 font-medium text-yellow'>Secure Checkout With</p>
                            <div className='flex flex-row max-w-50 w-full justify-between mx-auto mt-1'>
                                <Icons icon={'coinbase'} />
                                <span className='h-5.5 bg-white w-px'></span>
                                <p className='text-base font-bold leading-120 text-yellow'>Commerce</p>
                            </div>
                            <p className='leading-183 text-xs font-medium mt-1 text-yellow'>10+ Payment Methods Accepted:</p>
                            ...
                            <div key={index} className='flex flex-row flex-wrap'>
                                <div className='rounded-[10px] w-fit bg-[linear-gradient(90deg,#4020C1_0%,#8432D6_100%)] p-px'>
                                    <div className='rounded-[10px] gap-3 items-center flex flex-row max-w-75 w-full py-2.5 px-1.75 h-25 bg-dark'>
                                        ...
                                        <div>
                                            <h3 className='text-xs text-yellow leading-130'>{item.title}</h3>
                                            <p className='text-xs mt-1.25 text-yellow/80 leading-130'>{item.description}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='bg-[linear-gradient(90deg,#4020C1_0%,#8432D6_100%)] py-8.75 max-w-360 w-full min-h-[243.1px] mx-auto mt-8 lg:mt-0'>
                    <h2 className='text-yellow text-xl sm:text-2xl font-extrabold leading-110 uppercase text-center'>Hurry! next price increase</h2>
                    <div className='text-center max-w-[300.1px] flex flex-row justify-between mx-auto mt-7.5'>
                        <span className='font-light text-sm leading-100 text-yellow'>Hours</span>
                        <span className='font-light text-sm leading-100 text-yellow'>Minutes</span>
                        <span className='font-light text-sm leading-100 text-yellow'>Seconds</span>
                    </div>

        ...
        <div>
            <div className='bg-dark-yellow py-15.5 flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-22.5 max-w-360 w-full mx-auto px-4 sm:px-6 lg:px-0'>
                ...
                <div className='w-full lg:w-auto'>
                    ...
                    <p className='text-dark text-base inter sm:text-lg inter lg:text-xl inter font-normal inter mt-2.75 leading-200'>$hPEPE is more than just a meme; it's a viral juggernaut.</p>
                    <p className='text-dark font-normal inter text-base inter sm:text-lg inter lg:text-xl inter leading-150 max-w-full lg:max-w-[590.1px]'>Not only will the token list at 20x the presale price, but a significant portion of the presale will be utilized for viral guerrilla marketing!</p>
                </div>
                <Image
                    src={'/assets/png/moon.png'}
                    width={647}

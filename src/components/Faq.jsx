  ...
  return (
    <section className="px-5 bg-light-green pt-[40.1px] sm:pt-[60.1px] md:pt-[90.36px]">
      <div className="max-w-[1439.1px] w-full mx-auto flex flex-col items-center justify-center">
        <h1 className="font-normal text-5xl leading-110 text-yellow text-center mb-[23.61px] sm:mb-[59.64px]">
        ...
        <div className="flex flex-col">
          {FAQ_DATA.map((item) => (
            <div key={item.id} className="faqitem">
              ...
              >
                <h1 className="w-full font-semibold text-[16px] sm:text-[18px] lg:text-xl leading-[28.1px] sm:leading-[34.1px] text-[#FFFFFF] text-left mb-0">
                  {item.question}
                </h1>
              ...
              <div className={`max-w-[1141.1px] mx-auto pr-[32.1px] grid transition-all duration-300 ${openId === item.id ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
                <div className="overflow-hidden">
                  <p className="font-medium text-[14px] sm:text-[15px] lg:text-base leading-[160%] sm:leading-[140%] text-[#FFFFFF] mt-5">
                    {item.answer}
                  </p>
                </div>
              </div>
